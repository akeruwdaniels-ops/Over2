...
"""
╔══════════════════════════════════════════════════════════════════════════╗
║          DERIV DIGIT OVER 2 BOT — MAXIMUM PRECISION EDITION             ║
...
CFG = {
    ...
    "payout_ratio":                 0.05,  # ~5% payout on DIGITOVER2 (adjust to actual)
...
class Over2Bot:
    ...
    async def on_tick(self, tick: dict):
        ...
        # Update all online models on every tick (even during cooldown)
        ...
        # Signal evaluation on every tick (1-tick contracts)
    ...
    async def run(self):
        bar = "═" * 72
        log.info(bar)
        log.info("  DERIV DIGIT OVER 2 BOT  ·  R_100  ·  MAXIMUM PRECISION EDITION")
        log.info("  10-Layer Intelligence: Markov3 · HMM · Hawkes · SampEn · ARFIMA")
        log.info("                         Hurst · Bayesian · Copula · Kalman · Guard")
